    ...
    def search_contact(self, keyword):
        ...
        if results:
            ...
            for i, result in enumerate(results, start=1):
                print(f"{i}. Name: {result.name}, Phone: {result.phone}, Email: {result.email}, Address: {result.address}")
        else:
        ...
        for contact in self.contacts:
            if contact.name.lower() == name.lower():
                ...
                while not new_phone.isdigit():
                    new_phone = input("Please enter a valid phone number consisting only of digits: ")
    ...
    while True:
        ...
        if choice == "1":
            ...
            while not phone.isdigit():
                phone = input("Please enter a valid phone number consisting only of digits: ")
